        ...
        <header className='w-[70%] h-[57vh] flex flex-row items-center place-items-center justify-between'>
          <div className='w-[55%] h-full flex flex-col justify-around' id='headtext'>
            ...
            <section className='w-full flex flex-row justify-between'>
              <Link style={{"filter":"drop-shadow(2px 3px 4px rgb(143 96 169 / 0.4))"}} className='inline-block text-center bg-[#8F60A9] px-5 py-2 rounded-full text-[#E5E5E5] font-secondary text-[1vw] font-semibold hover:bg-[#D196FF]' to={'/register'}>START YOUR JOURNEY TODAY</Link>
              <Link style={{"filter":"drop-shadow(2px 3px 4px rgb(143 96 169 / 0.4))"}} className='inline-block text-center  px-5 py-2 rounded-full text-[#8F60A9] font-secondary text-[1vw] border-2 border-[#8F60A9] font-semibold hover:border-[#D196FF] hover:text-[#D196FF]' to={'/register'}>START YOUR JOURNEY TODAY</Link>
            </section>
          </div>
